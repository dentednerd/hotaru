export default {
  ...
  ladbible: {
    title: 'LADbible',
    category: 'LBG',
    caption: '<p>A single dynamic React-based platform powers the whole LADbible family of websites.</p><p>Different variants of the LADbible homepage are displayed to viewers in Australia and Ireland. Since GAMINGbible\'s success in displaying five articles per page, we\'ve recently implemented it for LADbible articles too.</p>',
    links: [
      {
        text: 'LADbible',
  ...
  unilad: {
    title: 'UNILAD',
    category: 'LBG',
    caption: '<p>A single dynamic React-based platform powers the whole LADbible family of websites.</p><p>UNILAD runs on a Wordpress CMS separately from the other channels, and its design and branding are very different from the other channels.</p>',
    links: [
      {
        text: 'UNILAD',
  ...
  gamingbible: {
    title: 'GAMINGbible',
    category: 'LBG',
    caption: '<p>A single dynamic React-based platform powers the whole LADbible family of websites.</p><p>GAMINGbible is our most recent project, bringing in new features such as multiple articles per screen whose adverts update on scroll, and a fully animated menu on mobile devices.</p>',
    links: [
      {
        text: 'GAMINGbible',
  ...
  tyla: {
    title: 'Tyla',
    category: 'LBG',
    caption: '<p>A single dynamic React-based platform powers the whole LADbible family of websites.</p><p>Tyla was the first channel to move onto the new platform that we started building in the autumn of 2018, but has since gone through a full rebranding and redesign, including a name change.</p><p>My favourite stylistic feature is the swipe animation on the navbar links.</p>',
    links: [
      {
        text: 'Tyla',
  ...
  sportbible: {
    title: 'SPORTbible',
    category: 'LBG',
    caption: '<p>A single dynamic React-based platform powers the whole LADbible family of websites.</p><p>SPORTbible was the first channel to which we added video and Twitter feeds on the homepage.</p>',
    links: [
      {
        text: 'SPORTbible',
  ...
  blogr: {
    title: 'FM: Blogr',
    category: 'JI',
    caption: '<p>This is another <a href="https://www.frontendmentor.io/">Frontend Mentor</a> solution, this time for a publishing platform landing page. It was a good opportunity to practise with CSS Grid. The hardest part was positioning that background image inside the header whilst keeping it responsive!</p>',
    links: [
      {
        text: 'Blogr',
